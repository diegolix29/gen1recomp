...
local FALLBACK_HEIGHTS = {
  ...
  prop = 16,
  cutout = 16,
  -- a vehicle drawn SIDE-ON: the showroom bicycles.
  bike = 16,
  console = 16,
  relief = 3,
  bookcase = 32,
...
--- its front (a tileset entry's bookcase_relief)?  Default yes.
...
--- wall_top). Returns a function tile -> cap tile id, or nil.
