...
local function loadColors()
  ...
  local tries = {}
  if V and V.path then tries[#tries + 1] = V.path .. "/data_dramatic/shiny_colors.lua" end
  tries[#tries + 1] = "data_dramatic/shiny_colors.lua"
  tries[#tries + 1] = "mods/DramaticShapeVoxelMod/data_dramatic/shiny_colors.lua"
